...
var s_account = spark.config.brandData.omnitureKeyword;
...
s.linkInternalFilters = "javascript:,Jdate.com,spark.net"
...
function getParameterByName(name) {
    ...
    var results = regex.exec(window.location.search.toUpperCase());
    if (results == null)
        return "";
    else
...
function s_doPlugins(s) {
    // Omniture's method doesn't work for more than 1 param..? Using pure js to retrieve.
    s.eVar11 = getParameterByName('prm');
    s.eVar12 = getParameterByName('eid');
    s.eVar13 = getParameterByName('lgid');
}
...
/*
* Plugin: getAndPersistValue v0.3 - persist a value across pages
*/
...
s.visitorNamespace = "sparknetworks"
s.dc = 112
...
made when instructed to do so by your account manager.*/
s.visitorNamespace = "sparknetworks"
s.trackingServer = "sparknetworks.112.2o7.net"
